            ...
            <div className="formbg-outer">
                ...
                onSubmit={async (values) => {
                  ...
                  try {
                    ...
                    if (data.error) {
                      ...
                      ReactSession.set("idAdmin", data.idAdmin);
                      ReactSession.set("name", data.AdNombre);
                      ReactSession.set("Appat", data.AdAppat);
                      ReactSession.set("Apmat", data.AdApmat);
              ...
              <div className="footer-link padding-top--24">
                ...
                <div className="listing padding-top--24 padding-bottom--24 flex-flex center-center">
                  ...
                  <span id="spanLogin">
                    <a id="linksLogin" href="#" className="terms__cta">
