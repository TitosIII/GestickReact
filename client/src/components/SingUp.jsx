        ...
        <section>
                    ...
                    <div className="col-xl-7 col-lg-12 d-flex">
                        <div className="container align-self-center p-6">
                            ...
                            <p className="text-muted mb-5">{
                                params.id ? "Ingrea La Siguiente Información Para Editar Administrador" : "Ingresa La Siguiente Información Para Registrarte"
                            }</p>
                            <Formik
                                initialValues={{
                                    AP:"",
            ...
            <section className="modal ">
                <div className="modal__container">
                    ...
                    <a href="#" className="modal__close">Aceptar terminos y condiciones</a>
                </div>
            </section>
