...
import { deleteAdmins,getAdminRequest, getAdminsRequest } from '../api/gestick.api.js'
...
export const AdminsContextPrvider = ({ children }) => {
    ...
    return (<AdminsContext.Provider value={{ admins, loadAdmins, deleteAdmin , getAdmin}}>
        {children}
